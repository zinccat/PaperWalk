...
class SemanticScholarAPI:
    ...
    def __init__(self, api_key=None):
        ...
        self.limit = 10
        self.max_limit = 10
        assert self.limit <= self.max_limit, "limit must be less than or equal to max_limit"
...
if __name__ == "__main__":
    ...
    for citation in api.fetch_references("649def34f8be52c8b66281af98ae884c09aef38b", fetch_all=True):
        print(citation)